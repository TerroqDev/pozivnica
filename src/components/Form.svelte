	...
	onMount(() => {
		inView(imeDiv, () => {
			animate(
				...
				{ duration: 1.2, easing: 'ease-in', delay: 0.3 }
			);
		});
		inView(prezimeDiv, () => {
			animate(
				prezimeDiv,
				{ opacity: [0, 100], y: [10, 0] },
				{ duration: 1.2, easing: 'ease-in', delay: 0.4 }
			);
		});
		inView(potvrdaDiv, () => {
			animate(
				potvrdaDiv,
				{ opacity: [0, 100], y: [10, 0] },
				{ duration: 1.2, easing: 'ease-in', delay: 0.5 }
			);
		});
		inView(brojDiv, () => {
			animate(
				brojDiv,
				{ opacity: [0, 100], y: [10, 0] },
				{ duration: 1.2, easing: 'ease-in', delay: 0.6 }
			);
		});
		inView(porukaDiv, () => {
			animate(
				porukaDiv,
				{ opacity: [0, 100], y: [10, 0] },
				{ duration: 1.2, easing: 'ease-in', delay: 0.7 }
			);
		});
		inView(callToAction, () => {
			animate(
				callToAction,
				{ opacity: [0, 100], y: [10, 0] },
				{ duration: 1.2, easing: 'ease-in', delay: 0.8 }
			);
		});
	});
</script>
