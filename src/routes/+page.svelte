...
<div
	class="relative flex min-h-screen flex-col bg-[url('https://woop14abphufecql.public.blob.vercel-storage.com/pozivnica/IMG_5277-cayuDdw42zwwHPSUYfh1lEr4R5m1it.JPEG')] bg-cover bg-fixed bg-center"
>
